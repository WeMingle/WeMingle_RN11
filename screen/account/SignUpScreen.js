...
import { SignUp } from '../../component/api/Account';
  ...
  return (
    <BaseSafeView>
      ...
      <Container>
        ...
        <CommonInput value={postData.memberId} onChangeText={(v) => setPostData(prev => {
        ...
        <CommonInput secureTextEntry value={postData.password} onChangeText={(v) => setPostData(prev => {
